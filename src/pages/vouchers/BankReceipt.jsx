...
const BankReceipt = () => {
  ...
  const onSubmit = (data) => {
    console.log('Bank Receipt Voucher:', data)
  }
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Bank Receipt Voucher</h1>
          <p className="text-gray-600 mt-1">Record money received in bank account</p>
        </div>
      </div>
