...
const CashPayment = () => {
  ...
  const onSubmit = (data) => {
    console.log('Cash Payment Voucher:', data)
  }
  ...
  return (
    <div>
      <div className="flex items-center gap-4 mb-6">
        ...
        <div>
          <h1 className="text-3xl font-bold text-gray-900">Cash Payment Voucher</h1>
          <p className="text-gray-600 mt-1">Record cash payments</p>
        </div>
      </div>
