  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-base font-semibold text-gray-900">Payments & Receipts</h1>
          <p className="text-[10px] text-gray-500 mt-0.5">Money in and out. For sales use Transactions.</p>
        </div>
