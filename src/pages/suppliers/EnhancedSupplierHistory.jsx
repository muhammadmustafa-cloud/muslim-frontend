...
const EnhancedSupplierHistory = () => {
  ...
  const {
    ...
    calculateTotals,
    refetch
  } = useTransactionHistory('supplier', supplierId)
  ...
  const handleEntitySelect = (selectedSupplierId) => {
  ...
  const handleExport = () => {
    ...
    try {
      if (exportFormat === 'pdf') {
        exportTransactionHistoryToPDF(transactions, supplier.name, 'supplier', filters)
      } else {
        exportTransactionHistoryToExcel(transactions, supplier.name, 'supplier', filters)
      }
...
export default EnhancedSupplierHistory
